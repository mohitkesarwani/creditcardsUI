...
function AdvancedFilters({ filters, setFilters, availableTags = [] }) {
  ...
  const clearAll = () => setFilters({ annualFee: '', features: [] });

  return (
    <div className="mb-4 space-y-4 bg-white/80 p-4 rounded-lg shadow-md hover:shadow-lg transition divide-y divide-gray-200">
