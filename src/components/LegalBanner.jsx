...
export default function LegalBanner() {
  ...
  return (
    <div role="region" aria-label="General-advice notice"
         className="bg-amber-50/80 backdrop-blur border-b border-amber-200/70 text-amber-900 text-xs md:text-sm">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-2 flex items-start gap-3">
        ...
        <button
          ...
          className="text-amber-700 hover:text-amber-900 hover:bg-amber-100/60 rounded-full w-6 h-6 flex items-center justify-center transition-colors"
        >
          ×
        </button>
      </div>
